...
namespace Echo.Xmpp.ElementModel
{
	...
	{
		public static readonly XName ElementName = XName.Get("message", CoreNamespaces.Client);
		...
		public XmppMessage(XmppMessageKind kind = XmppMessageKind.Normal, string sender = null, string target = null, string body = null, bool generateId = true, params object[] content) : base(ElementName, content)
		{
			Kind = kind;
			Sender = sender;
			Target = target;
